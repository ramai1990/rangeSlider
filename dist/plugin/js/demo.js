...
/***/ "./src/app/styles/jquery.range.scss":
/*!******************************************!*\
  !*** ./src/app/styles/jquery.range.scss ***!
  \******************************************/
...
/* harmony export */ });
/* harmony import */ var _Model_Model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Model/Model */ "./src/app/ts/Model/Model.ts");
/* harmony import */ var _View_MainView_MainView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../View/MainView/MainView */ "./src/app/ts/View/MainView/MainView.ts");
/* harmony import */ var _Presenter_Presenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Presenter/Presenter */ "./src/app/ts/Presenter/Presenter.ts");



class App {
    constructor(target, options) {
        this.presenter = new _Presenter_Presenter__WEBPACK_IMPORTED_MODULE_2__.default(new _View_MainView_MainView__WEBPACK_IMPORTED_MODULE_1__.default(target, options), new _Model_Model__WEBPACK_IMPORTED_MODULE_0__.default(options));
    }
    update(state) {
...
class Model {
    ...
    static valueToPercent(min, max, value) {
        const range = max - min;
    ...
    static validateGridDensity(state) {
        ...
        if (validatedGridDensity < _const__WEBPACK_IMPORTED_MODULE_1__.GRID_DENSITY_MIN)
    ...
    static validateValues(state) {
        const { value, value2, max, isRange, } = state;
        return {
            value: this.validateValue('value', value, state),
            value2: isRange && value2 === null ? max : this.validateValue('value2', value2, state),
        };
    }
    static validateValue(prop, valueToValidate, state) {
        const { min, max, value, value2, isRange, step, } = state;
        ...
        if (isRange) {
            ...
            if (prop === 'value' && outValue > value2AlignedToStep)
                outValue = value2AlignedToStep;
            if (prop === 'value2' && outValue < valueAlignedToStep)
                outValue = valueAlignedToStep;
        }
    ...
    static checkBoundaries(position) {
        const boundStart = 0;
        const boundEnd = 100;
    ...
    updateModelExtraPosition(extra) {
        const { min, max, value, value2, } = this.state;
        return {
            redraw: extra.redraw,
...
/***/ "./src/app/ts/Observer/Observer.ts":
/*!*****************************************!*\
  !*** ./src/app/ts/Observer/Observer.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/app/ts/Presenter/Presenter.ts":
/*!*******************************************!*\
  !*** ./src/app/ts/Presenter/Presenter.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/app/ts/View/BarView/BarView.ts":
/*!********************************************!*\
  !*** ./src/app/ts/View/BarView/BarView.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = __webpack_require__(/*! ./BarView.pug */ "./src/app/ts/View/BarView/BarView.pug");
class BarView {
    constructor($slider) {
        this.$slider = $slider;
...
/***/ "./src/app/ts/View/BubbleView/BubbleView.ts":
/*!**************************************************!*\
  !*** ./src/app/ts/View/BubbleView/BubbleView.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = __webpack_require__(/*! ./BubbleView.pug */ "./src/app/ts/View/BubbleView/BubbleView.pug");
class BubbleView {
    ...
    init(state) {
        ...
        this.$element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(template({ state, type: this.type }));
...
/***/ "./src/app/ts/View/GridView/GridView.ts":
/*!**********************************************!*\
  !*** ./src/app/ts/View/GridView/GridView.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = __webpack_require__(/*! ./GridView.pug */ "./src/app/ts/View/GridView/GridView.pug");
class GridView {
    constructor($slider, state) {
        this.handleTickClick = (e) => {
...
/***/ "./src/app/ts/View/HandleView/HandleView.ts":
/*!**************************************************!*\
  !*** ./src/app/ts/View/HandleView/HandleView.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = __webpack_require__(/*! ./HandleView.pug */ "./src/app/ts/View/HandleView/HandleView.pug");
class HandleView {
    constructor($slider, state) {
...
/***/ "./src/app/ts/View/MainView/MainView.ts":
/*!**********************************************!*\
  !*** ./src/app/ts/View/MainView/MainView.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = __webpack_require__(/*! ./MainView.pug */ "./src/app/ts/View/MainView/MainView.pug");
class MainView {
    ...
    update(state, extra) {
        ...
        if (this.barView) {
            this.barView.update(this.handleToView ? fromPosition : 0, this.handleToView ? toPosition : fromPosition);
        }
        return this;
    }
    onChange(callback) {
    ...
    init(state) {
        ...
        this.$element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(template({ state }));
    ...
    announceJump(e) {
        ...
        if (this.handleToView) {
            statePropName = MainView.getClosestValuePropName(cursorPosition, this.handleFromView.getCurrentPosition(), this.handleToView.getCurrentPosition());
        }
        ...
        const state = { [statePropName]: null };
        const extra = { percent: cursorPosition };
    ...
    announceDrag(e) {
        ...
        if (this.$draggingHandle) {
            const statePropName = this.$draggingHandle.hasClass('js-range-slider__handle_type_to')
                ...
                : 'value';
            const state = { [statePropName]: null };
            const extra = { percent: this.getCursorPosition(e) };
            this.announcer.trigger('change.view', state, extra);
        }
    }
    announceClickTick(value) {
        const statePropName = this.handleToView
            ? MainView.getClosestValuePropName(value, this.handleFromView.getCurrentValue(), this.handleToView.getCurrentValue())
            : 'value';
        const state = { [statePropName]: value };
...
/***/ "./src/app/ts/View/RangeBubbleView/RangeBubbleView.ts":
/*!************************************************************!*\
  !*** ./src/app/ts/View/RangeBubbleView/RangeBubbleView.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = __webpack_require__(/*! ./RangeBubbleView.pug */ "./src/app/ts/View/RangeBubbleView/RangeBubbleView.pug");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DEFAULT_MIN": () => (/* binding */ DEFAULT_MIN),
/* harmony export */   "DEFAULT_MAX": () => (/* binding */ DEFAULT_MAX),
/* harmony export */   "DEFAULT_STEP": () => (/* binding */ DEFAULT_STEP),
/* harmony export */   "DEFAULT_VALUE": () => (/* binding */ DEFAULT_VALUE),
/* harmony export */   "DEFAULT_VALUE_2": () => (/* binding */ DEFAULT_VALUE_2),
/* harmony export */   "DEFAULT_GRID_DENSITY": () => (/* binding */ DEFAULT_GRID_DENSITY),
/* harmony export */   "DEFAULT_RANGE": () => (/* binding */ DEFAULT_RANGE),
/* harmony export */   "DEFAULT_VERTICAL": () => (/* binding */ DEFAULT_VERTICAL),
/* harmony export */   "DEFAULT_SHOW_BUBBLE": () => (/* binding */ DEFAULT_SHOW_BUBBLE),
/* harmony export */   "DEFAULT_SHOW_GRID": () => (/* binding */ DEFAULT_SHOW_GRID),
/* harmony export */   "DEFAULT_SHOW_BAR": () => (/* binding */ DEFAULT_SHOW_BAR),
/* harmony export */   "GRID_DENSITY_MIN": () => (/* binding */ GRID_DENSITY_MIN),
/* harmony export */   "GRID_DENSITY_MAX": () => (/* binding */ GRID_DENSITY_MAX)
/* harmony export */ });
const DEFAULT_MIN = 0;
...
/***/ "./src/demo/pages/demo-page/demo-page.ts":
/*!***********************************************!*\
  !*** ./src/demo/pages/demo-page/demo-page.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _app_ts_jquery_range__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../app/ts/jquery.range */ "./src/app/ts/jquery.range.ts");
...
const updateForm = ($form, state) => {
    ...
    $textInputs.each((_, configInput) => {
        const name = toCamelCase(jquery__WEBPACK_IMPORTED_MODULE_0___default()(configInput).attr('name'));
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(configInput).val(state[name]);
    });
};
const handleConfigInputChange = (event, api) => {
    const propName = toCamelCase(jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).attr('name'));
    const propValue = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).hasClass('js-slider-config__input_type_checkbox')
        ? jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).is(':checked')
        : Number(jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).val());
    api.update({
        [propName]: propValue,
    });
};
const setEventListeners = ($form, api) => {
    $form.find('.js-slider-config__input').each((_, input) => {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(input).on('change', (event) => handleConfigInputChange(event, api));
    });
};
const init = ($targets) => {
...
init(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-slider-group__target-input'));
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.scss */ "./src/demo/index.scss");
/* harmony import */ var _pages_demo_page_demo_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/demo-page/demo-page */ "./src/demo/pages/demo-page/demo-page.ts");
