...
class Model extends _Observer_Observer__WEBPACK_IMPORTED_MODULE_0__.default {
    ...
    static validateValues(state) {
        ...
        return {
            ...
            value2: isValueNull
                ? max
                : this.validateValue('value2', value2, state),
        };
    }
...
class GridView {
    ...
    getTicks(state) {
        const { min, max, gridDensity, step, } = state;
        const ticks = [];
...
class MainView {
    ...
    announceDrag(e) {
        ...
        if (this.$draggingHandle) {
            ...
            const extra = {
                percent: this.getCursorPosition(e),
            };
            this.announcer.trigger('change.view', state, extra);
        }
    }
    ...
    getCursorPosition(e) {
        ...
        return ((cursorPositionPx - trackOffsetPx + this.handleCenterOffset)
            / percentUnitPx);
    }
